package com.example.ecommereceapp.fragments;
...
import com.example.ecommereceapp.activities.ShowAllActivity;
import com.example.ecommereceapp.adapter.CategoryAdapter;
import com.example.ecommereceapp.adapter.NewProductsAdapter;
import com.example.ecommereceapp.adapter.PopularProductsAdapter;
import com.example.ecommereceapp.models.CategoryModel;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        slideModels.add(new SlideModel(R.drawable.banner1, "Discount on new metal keychains", ScaleTypes.CENTER_CROP));
        slideModels.add(new SlideModel(R.drawable.banner2, "Discount on new necklaces", ScaleTypes.CENTER_CROP));
        ...
        newProductRecylerview.setAdapter(newProductsAdapter);
